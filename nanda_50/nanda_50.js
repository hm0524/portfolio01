...
(function () {
	...
	$('#id_menu').load('../temp_menu.html', function() {
		...
		$.when(
			...
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/07/coma012.gif" alt="coma01" style="display: block;"></p>';
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/07/coma022.gif" alt="coma02" style="display: block;"></p>';
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/07/coma032.gif" alt="coma03" style="display: block;"></p>';
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/07/coma042.gif" alt="coma04" style="display: block;"></p>';
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/07/coma052.gif" alt="coma05" style="display: block;"></p>';
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/07/coma062.gif" alt="coma06" style="display: block;"></p>';
