...
(function () {
	...
	$('#id_menu').load('../temp_menu.html', function() {
		...
		$.when(
			...
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/09/coma01.gif" alt="coma01" style="display: block;"></p>';
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/09/coma02.gif" alt="coma02" style="display: block;"></p>';
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/09/coma03.gif" alt="coma03" style="display: block;"></p>';
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/09/coma04.gif" alt="coma04" style="display: block;"></p>';
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/09/coma05.gif" alt="coma05" style="display: block;"></p>';
			setHtml = setHtml + '<p class="imgCenter"><img src="http://static.cre-m.jp/wp-content/uploads/2016/09/coma06.gif" alt="coma06" style="display: block;"></p>';
